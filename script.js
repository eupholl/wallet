...
async function analyzeWallet() {
    ...
    var address = walletInput ? walletInput.value.trim() : "";
    ...
    try {
        ...
        alert("Не удалось загрузить данные кошелька. Проверьте адрес!");
    } finally {
